...
if(location.pathname.endsWith('/roulette207.html')){
  ...
  pointerStyle.textContent=`.pointer{position:absolute!important;z-index:999!important;top:-8px!important;left:50%!important;transform:translateX(-50%)!important;width:58px!important;height:76px!important;background:linear-gradient(135deg,#fffbd1 0%,#ffe95a 14%,#ffc400 38%,#ff9d00 64%,#9b4d00 100%)!important;clip-path:polygon(50% 100%,4% 28%,10% 12%,27% 2%,50% 0,73% 2%,90% 12%,96% 28%)!important;filter:drop-shadow(0 5px 4px rgba(0,0,0,.95)) drop-shadow(0 0 12px rgba(255,194,0,.8))!important;pointer-events:none!important}.pointer:before{content:""!important;position:absolute!important;left:9px!important;right:9px!important;top:9px!important;bottom:13px!important;background:linear-gradient(180deg,#ff6655 0%,#ff2f20 22%,#e40012 52%,#8b0010 82%,#430006 100%)!important;clip-path:polygon(50% 100%,0 0,100% 0)!important;border-radius:7px!important;box-shadow:inset 0 2px 1px rgba(255,255,255,.75),inset 0 -10px 12px rgba(40,0,0,.55),0 2px 5px rgba(0,0,0,.55)!important}.pointer:after{content:""!important;position:absolute!important;left:50%!important;top:3px!important;width:13px!important;height:13px!important;transform:translateX(-50%)!important;border-radius:50%!important;background:radial-gradient(circle at 30% 25%,#fff 0%,#fff7b0 25%,#ffd21f 55%,#e98500 78%,#6b3300 100%)!important;border:2px solid #7a4600!important;box-shadow:0 0 0 2px rgba(255,232,100,.65),0 0 14px rgba(255,194,0,1),inset -2px -2px 3px rgba(80,30,0,.6)!important}.pointer{transform:translateX(-50%) perspective(180px) rotateX(7deg)!important}`;
