...
freeSpinBetElements.forEach((id) => {
const elemento = document.getElementById(id);
...
.forEach((elemento) => {
  ...
  switch (campo) {
    ...
    case "bonus_balance":
    case "bonus":
      valor = formatarDinheiro(bonusBalance);
      break;
    case "cashBalance":
    case "cash_balance":
      valor = formatarDinheiro(cashBalance);
      break;
    case "reservedBalance":
    case "reserved_balance":
      valor = formatarDinheiro(reservedBalance);
      break;
    case "bonusWagerProgress":
    case "bonus_wager_progress":
      valor = formatarDinheiro(bonusWagerProgress);
      break;
    case "rouletteFreeSpins":
    case "roulette_free_spins":
      valor = formatarNumero(rouletteFreeSpins);
      break;
