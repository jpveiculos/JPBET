...
function renderWheel(){
 ...
 const orange=document.createElementNS(ns,'linearGradient');orange.setAttribute('id','prizeOrange');orange.setAttribute('x1','0%');orange.setAttribute('y1','0%');orange.setAttribute('y2','100%');orange.innerHTML='<stop offset="0%" stop-color="#ffcf80"/><stop offset="22%" stop-color="#ffad32"/><stop offset="65%" stop-color="#ff8500"/><stop offset="100%" stop-color="#b84b00"/>';defs.appendChild(orange);
