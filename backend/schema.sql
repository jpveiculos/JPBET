-- =========================================================
-- MayBets - ESTRUTURA PRINCIPAL DO BANCO
-- =========================================================
...
INSERT INTO users (username, password_hash, balance, bonus_balance, cash_balance, bonus_wager_progress)
VALUES ('admin', '123456', 1000.00, 0, 1000.00, 100.00)
ON CONFLICT (username) DO NOTHING;
